...
@include('_partials.base4tone-logo_900x300_svg')
</header>

<p>Base4Tone is an opinionated system for working with variables in webdesign, and is also used to generate a collection of colorthemes for many different applications in dark - and light versions. Applications like:</p>
<ul>
